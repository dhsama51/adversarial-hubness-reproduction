...
DATA_DIR = os.path.expanduser("~/projects/hubness/results/openai_clip/ahd_input_universal_only")
OUT_DIR = os.path.expanduser("~/projects/hubness/results/openai_clip/official_detector/mixed_universal_only")
...
print(f"전체 {len(labels)}개 (universal hub {n_hubs}개, 비율 {n_hubs/len(labels)*100:.2f}%)")
