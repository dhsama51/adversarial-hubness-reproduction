...
RESULTS_DIR = os.path.expanduser("~/projects/hubness/results/laion_clip/hubs")
...
CLUSTER_CACHE_PATH = os.path.join(EMB_DIR, f"cluster_cache_laion_k{N_CLUSTERS_TOTAL}.npz")
...
print(f"선택된 클러스터: {chosen_clusters}\n")
